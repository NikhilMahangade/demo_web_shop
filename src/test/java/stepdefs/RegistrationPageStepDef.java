...
public class RegistrationPageStepDef {
    ...
    public void i_am_on_the_tricentis_demo_web_shop_registration_page() {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I navigates to registration page");
    }
    ...
    public void i_select_male_gender() {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I navigates to login page");
    }
    ...
    public void i_enter_firstname_lastname_and_email(String firstName, String lastName, String email) {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I enter firstname lastname and email");
    ...
    public void i_enter_password_and_confirm_password(String password, String confirmPassword) {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I enter password and confirm password");
    ...
    public void i_click_on_the_register_button() {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I click on the Register button");
    ...
    public void i_should_be_successfully_registered_and_see_logout() {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I should be successfully registered and see the logout button");
    ...
    public void i_submit_invalid_registration(String firstName, String lastName, String email, String password, String confirmPassword) {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I submit invalid registration with firstname, lastname, email, password, confirm password");
    ...
    public void i_should_see_a_registration_error(String expectedMessage) {
        ...
        ExtentReportManager.getTest().log(Status.INFO, "I should see a registration error containing");
